...
from clst-test.types import Entity, EntityListResponse, PnlSummary
...
class TestEntities:
    ...
    @parametrize
    def test_method_pnl_summary(self, client: ClstTest) -> None:
        entity = client.entities.pnl_summary(
            "x",
        )
        assert_matches_type(PnlSummary, entity, path=['response'])

    @parametrize
    def test_raw_response_pnl_summary(self, client: ClstTest) -> None:

        response = client.entities.with_raw_response.pnl_summary(
            "x",
        )
    ...
    @parametrize
    def test_streaming_response_pnl_summary(self, client: ClstTest) -> None:
        with client.entities.with_streaming_response.pnl_summary(
            "x",
        ) as response :
            assert not response.is_closed
            assert response.http_request.headers.get('X-Stainless-Lang') == 'python'
    ...
    @parametrize
    def test_path_params_pnl_summary(self, client: ClstTest) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `entity_id` but received ''"):
          client.entities.with_raw_response.pnl_summary(
              "",
          )
class TestAsyncEntities:
    ...
    @parametrize
    async def test_method_pnl_summary(self, async_client: AsyncClstTest) -> None:
        entity = await async_client.entities.pnl_summary(
            "x",
        )
        assert_matches_type(PnlSummary, entity, path=['response'])

    @parametrize
    async def test_raw_response_pnl_summary(self, async_client: AsyncClstTest) -> None:

        response = await async_client.entities.with_raw_response.pnl_summary(
            "x",
        )
    ...
    @parametrize
    async def test_streaming_response_pnl_summary(self, async_client: AsyncClstTest) -> None:
        async with async_client.entities.with_streaming_response.pnl_summary(
            "x",
        ) as response :
            assert not response.is_closed
            assert response.http_request.headers.get('X-Stainless-Lang') == 'python'
    ...
    @parametrize
    async def test_path_params_pnl_summary(self, async_client: AsyncClstTest) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `entity_id` but received ''"):
          await async_client.entities.with_raw_response.pnl_summary(
              "",
          )