...
async def test_basic(sync: bool, client: ClstTest, async_client: AsyncClstTest) -> None:
...
async def test_data_missing_event(
    sync: bool, client: ClstTest, async_client: AsyncClstTest
) -> None:
    def body() -> Iterator[bytes]:
        yield b'data: {"foo":true}\n'
        yield b"\n"
